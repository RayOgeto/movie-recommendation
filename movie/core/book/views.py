...
def get_movie_recommendations(request):
    url = "https://movie-and-show-recommendation.p.rapidapi.com/recommend/movie"
    headers = {
        'x-rapidapi-key': settings.RAPIDAPI_KEY,
        'x-rapidapi-host': settings.RAPIDAPI_HOST
    }
    
    movie_id = request.GET.get('movie_id', 'tt1375666')  # default to Inception's IMDb ID
    # movie_name = request.GET.get('movie_name', 'Inception')
